...
describe("bucket", () => {
	describe("safeBucketName", () => {
		...
		it("should truncate a long name", () => {
			const n =
				"some-very-long-bucket-name-that-is-too-long-to-be-an-actual-bucket-name-for-gcs";
			const b = safeBucketName(n);
			const e =
				"some-very-long-bucket-name-that-is-too-long-to-be-an-actual-buc";
			assert(b === e);
		});

		it("should safely truncate a long name", () => {
			const n =
				"some-very-long-bucket-name-that-is-too-long-to-be-an-actual-bu-cket-name-for-gcs";
			const b = safeBucketName(n);
			const e =
				"some-very-long-bucket-name-that-is-too-long-to-be-an-actual-bu";
			assert(b === e);
		});
